...
<head>
    ...
    <title>Edit data into database using PDO in PHP</title>
</head>
<body>
<div class="container">
<div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mt-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3>Edit data into database using PDO in PHP</h3>
                    </div>
                    <div class="card-body">
                    <?php
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM tbl_member WHERE id=:stud_id LIMIT 1";
...
<div class="mb-3">
    <label>Phone</label>
    <input type="text" name="password" value="<?= $result->password; ?>" class="form-control" />
</div>
