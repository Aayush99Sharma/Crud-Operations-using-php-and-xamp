...
<BODY>
  ...
  <span class="login-signup btn btn-warning"><a href="fetch4.php" style="color:white">DELETE</a></span>
  <span class="login-signup btn btn-warning"><a href="fetch2.php" style="color:white">UPDATE</a></span>
  <span class="login-signup btn btn-warning"><a href="Fetch.php" style="color:white">DISPLAY</a></span>
  <span class="login-signup btn btn-warning"><a href="student-add.php" style="color:white">INSERT</a></span>
